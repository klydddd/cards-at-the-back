...
// Pages the visitor must be able to use before finishing
...
export default function WelcomeGate() {
    ...
    useEffect(() => {
        ...
        const onKeyDown = (e: KeyboardEvent) => {
            ...
            const focusable = Array.from(
                dialogRef.current.querySelectorAll<HTMLElement>('a[href], button, input, select')
    ...
    return (
        <div className="consent-backdrop">
            ...
            >
                <div className="index-card-head">{headLabel}</div>
                ...
                {step === 'done' && (
                    <div className="index-card-body consent-body">
                        ...
                        <button type="button" className="btn btn-primary consent-agree" onClick={() => setStep(null)}>
                            Start studying
                        </button>
                    </div>
                )}
